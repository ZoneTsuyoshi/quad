...
import numpy as np
import torch
import data, parse, models, trainer
...
def main(args: argparse.Namespace, logger):
    ...
    # prepare trainer
    trainer = trainer.Trainer(model, device, logger, args.result_dir, train_inputs, train_outputs, valid_inputs, valid_outputs, args.criterion, args.batch_size, args.n_epochs, args.optimizer, args.learning_rate, args.max_grad_norm, args.n_evaluate_every)
